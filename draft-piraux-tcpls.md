...
allows a TCPLS receiver to indicate the highest sequence number received on a
specific connection. The ACK frame can be sent over any TCP connection of a TCPLS
session.
...
The security considerations for TLS apply to TCPLS. Additional security considerations will be documented in the next version of this document. 
...
The authors thank Quentin De Coninck for his
